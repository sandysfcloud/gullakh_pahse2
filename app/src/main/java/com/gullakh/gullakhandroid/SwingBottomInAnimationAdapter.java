...
public class SwingBottomInAnimationAdapter extends SingleAnimationAdapter {
    ...
    @Override
    @NonNull
    protected com.nineoldandroids.animation.Animator getAnimator(@NonNull final ViewGroup parent, @NonNull final View view) {
        return com.nineoldandroids.animation.ObjectAnimator.ofFloat(view, TRANSLATION_Y, parent.getMeasuredHeight() >> 1, 0);
    }
