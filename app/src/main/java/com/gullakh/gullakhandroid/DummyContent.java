...
public class DummyContent {
	...
	public static ArrayList<DummyModel> getTravelDummyList() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, "", "Home", R.string.material_icon_go));
		list.add(new DummyModel(1, "", "Outline", R.string.material_icon_play_outline));
		list.add(new DummyModel(2, "", "Questionnaire", R.string.material_icon_statistics));
		list.add(new DummyModel(3, "", "Know Your Size", R.string.material_icon_plus_box));
		list.add(new DummyModel(4, "", "My Wardrobe", R.string.material_icon_party));
		list.add(new DummyModel(5, "", "Help", R.string.material_icon_play));
		list.add(new DummyModel(6, "", "Contact", R.string.material_icon_shop));
		return list;
	}
