...
public class DataHandler extends SQLiteOpenHelper {
    ...
    public void addTable() {
        try {
            ...
            android_metadata= "CREATE TABLE IF NOT EXISTS userlogin (id INTEGER PRIMARY KEY AUTOINCREMENT,user_id VARCHAR,contact_id VARCHAR,useremail VARCHAR,usermobile VARCHAR,usersession VARCHAR,profile VARCHAR ,dob VARCHAR ,gender VARCHAR,score VARCHAR,firstname VARCHAR,lastname VARCHAR,street VARCHAR,city VARCHAR,state VARCHAR,country VARCHAR,zip VARCHAR,date VARCHAR,address VARCHAR);";
