...
import com.gullakh.gullakhandroidapp.WrapperViewList.LifeCycleListener;
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mPaddingLeft = a.getDimensionPixelSize(2, padding);
                mPaddingTop = a.getDimensionPixelSize(3, padding);
                mPaddingRight = a.getDimensionPixelSize(4, padding);
                mPaddingBottom = a.getDimensionPixelSize(5, padding);
