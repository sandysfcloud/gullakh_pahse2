package com.gullakh.gullakhandroidapp.font;
...
import com.gullakh.gullakhandroidapp.R;

/**
 * Created by njfernandis on 27/04/16.
 */
public class RobotoAutoText extends AutoCompleteTextView {


    public RobotoAutoText(Context context) {
        super(context);
        if (isInEditMode()) return;
        parseAttributes(null);
    }

    public RobotoAutoText(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (isInEditMode()) return;
        parseAttributes(attrs);
    }

    public RobotoAutoText(Context context, AttributeSet attrs, int defStyle) {
