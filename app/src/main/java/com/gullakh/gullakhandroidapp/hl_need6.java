...
public class hl_need6 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* AutoCompleteAdapter adapter = new AutoCompleteAdapter(hl_need6.this, android.R.layout.simple_dropdown_item_1line, android.R.id.text1, new ArrayList<String>(0));
